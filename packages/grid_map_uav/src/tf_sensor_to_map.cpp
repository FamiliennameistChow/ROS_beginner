...
int main(int argc, char** argv){
    ros::init(argc, argv, "tf_sensor2map");
    ros::NodeHandle nh("~");
    ros::Rate rate(50);
    ...
    nh.param<double>("sensor_transform_from_robot/rotation/r", R, 0.0);
    nh.param<double>("sensor_transform_from_robot/rotation/p", P, 3.1415926);
    nh.param<double>("sensor_transform_from_robot/rotation/y", Y, 1.5707963);
