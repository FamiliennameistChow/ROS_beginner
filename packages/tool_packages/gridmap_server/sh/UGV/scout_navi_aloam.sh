...
--tab -e 'bash -c "sleep 15; roslaunch gridmap_server pointcloud_to_gridmap.launch; exec bash"' \
--tab -e 'bash -c "sleep 10; roslaunch octomap_scout tf_trans_aloam.launch; exec bash"' \
--tab -e 'bash -c "sleep 15; roslaunch gridmap_server test_navi_map.launch; exec bash"' 
