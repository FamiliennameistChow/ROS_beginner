...
--tab -e 'bash -c "sleep 20; roslaunch gridmap_server pointcloud_to_gridmap.launch; exec bash"' \
--tab -e 'bash -c "sleep 20; roslaunch gridmap_server test_navi_map.launch; exec bash"' 
