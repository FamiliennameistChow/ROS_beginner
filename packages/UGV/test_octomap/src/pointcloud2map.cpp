...
int main(int argc, char ** argv){
    ...
    private_nh.param<std::string>("pointcloud_trans_topic", pointcloud_trans_topic, std::string("/camera/depth/points_global"));
    private_nh.param<std::string>("pointcloud_in_topic", pointcloud_in_topic, std::string("/camera/depth/points"));
