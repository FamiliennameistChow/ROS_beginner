gnome-terminal --window -e 'bash -c "roslaunch gridmap_scout scout_moon_sim.launch; exec bash"' \
--tab -e 'bash -c "sleep 5; rosrun teleop_twist_keyboard teleop_twist_keyboard.py; exec bash"' \
--tab -e 'bash -c "sleep 6; roslaunch gridmap_scout aloam_velodyne_VLP_16.launch; exec bash"' \
