...
--tab -e 'bash -c "sleep 5; cd /home/bornchow/Downloads/rosbag/outside && rosbag play -r 0.9 --clock 2020-08-10-11-44-09.bag --topic /zed_node/left_raw/image_raw_color /velodyne_points; exec bash"' \
