...
private:
    ...
    // A algorithm
    shared_ptr<GraphGroupSearch> A_star_search_;
...
n_(nh_)
{
    ...
    //ros 订阅与发布
    global_map_sub_ = n.subscribe("/gridMap", 10, &AStart::mapCallBack, this);
    goal_sub_ = n.subscribe("/clicked_point", 10, &AStart::goalCallBack, this);
